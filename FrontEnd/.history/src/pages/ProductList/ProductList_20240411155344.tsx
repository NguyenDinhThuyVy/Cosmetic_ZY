    ...
    <div className='h-full flex flex-col'>
      <div className=' min-h-32'>
        ...
        <div className='my-6 mx-28'>
          ...
          <div className=' grid grid-cols-8 py-4 px-1 place-items-center '>
            <Link to='/'>
              <ItemCategory img='category1.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category2.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category3.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category4.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category5.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category6.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category7.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
            <Link to='/'>
              <ItemCategory img='category8.webp' name='Chăm sóc da'></ItemCategory>
            </Link>
          </div>
        </div>
      </div>
