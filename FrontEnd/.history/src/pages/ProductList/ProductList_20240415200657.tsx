      ...
      <div className=' min-h-32'>
        ...
        <div className='my-6 mx-28 w-5/6 flex flex-col  items-center justify-center bg-[#ffc8b5] rounded-lg '>
          <div className='flex justify-between pt-10 items-center w-full px-8'>
            ...
            <div className='marquee bg-gray-200 overflow-hidden w-[100px]'>
              <p className='inline-block whitespace-nowrap animate-marquee text-rose-300'>
                Xin chào! Đây là văn bản chạy liên tục.
              </p>
            </div>
