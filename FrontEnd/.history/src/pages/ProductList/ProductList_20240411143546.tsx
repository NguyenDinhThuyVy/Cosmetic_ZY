    ...
    <div className='h-full flex flex-col'>
      <div className=' min-h-32'>
        ...
        <div className='my-6 mx-28'>
          <div className='text-gray-400 uppercase pt-7 px-5 flex gap-3 font-bold text-xl'>
            Danh Mục Nổi Bật
            <img width='30' height='30' src='https://img.icons8.com/color/48/cute-hamster.png' alt='cute-hamster' />
          </div>
          <div className=' grid grid-cols-8 py-5 px-2 place-items-center '>
            <Link to='/'>
              <ItemCategory img='category1.webp' name='Thời Trang Nam'></ItemCategory>
            </Link>
          </div>
        </div>
      </div>
