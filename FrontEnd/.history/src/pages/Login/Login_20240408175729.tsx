              ...
              <form className='p-10 roundedshadow-sm'>
                ...
                <div className='mt-8'>
                  <input
                    type='email'
                    name='email'
                    className='p-3 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-lg focus:shadow-sm place '
                    placeholder='Email'
                  />
                ...
                <div className='mt-3'>
                  <input
                    type='password'
                    name='password'
                    className='p-3 w-full outline-none border-none border-gray-300 focus:border-gray-500 rounded-lg focus:shadow-sm place'
                    placeholder='Password'
                  />
                  <div className='mt-1 text-red-600 min-h-[1rem] text-sm'></div>
                </div>
                <div className='mt-3'>
                  <button className='w-full text-center py-4 border-none rounded-lg  px-2 uppercase bg-pink_3 text-white text-sm hover:bg-pink_3/90 '>
                    Đăng nhập
                  </button>
                </div>
