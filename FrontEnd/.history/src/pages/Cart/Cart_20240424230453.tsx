            ...
            <table className='table-shop'>
              <thead>
                <tr className='font-medium '>
                  ...
                  <th className='pl-[15px]  product-quantity  w-[10%]'>Quantity</th>
                  <th className='pl-[10px] text-left product-subtotal w-[15%]'>Total</th>
                  <th className='pl-[10px] text-left product-subtotal w-[17%]'>Remaining quantity</th>
                </tr>
              </thead>
              <tbody>
                <CartItem></CartItem>
