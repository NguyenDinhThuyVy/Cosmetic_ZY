            ...
            <table className='table-shop'>
              <thead>
                <tr className='font-medium '>
                  ...
                  <th className='px-1 product-price'>Đơn Giá</th>

                  <th className='pl-[15px]  product-quantity  w-[10%]'>Số lượng</th>
                  <th className='pl-[10px] text-left product-subtotal w-[10%]'>Tổng tiền</th>
                  <th className='pl-[10px] text-left product-subtotal w-[10%]'>Số lượng còn lại</th>
                </tr>
              </thead>
              <tbody>
                <CartItem></CartItem>
