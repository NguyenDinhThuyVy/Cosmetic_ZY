                ...
                renderPopover={
                  <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                    <div className='flex flex-col py-2 pr-10 pl-3'>
                      <button className='py-2 px-3 text-left hover:text-rose-300'>Giá từ thấp đến cao</button>
                      <button className='py-2 px-3 text-left hover:text-rose-300 mt-2'>Giá từ cao đến thấp</button>
                    </div>
                  </div>
                }
              >
