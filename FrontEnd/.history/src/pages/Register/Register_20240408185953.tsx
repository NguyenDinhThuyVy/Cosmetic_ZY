        ...
        <div className='max-w-6xl mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-5 py-8 lg:py-14 lg:pr-10 bg-white'>
            <div className='lg:col-span-3 lg:col-start-1 px-6'>
              <img
                src='https://tronhouse.com/assets/data/editor/source/bi-quyet-chup-hinh-my-pham-gay-an-tuong-voi-nguoi-xem/chup-hinh-my-pham-8.jpghttps://studiovietnam.com/wp-content/uploads/2020/10/cach-tao-dang-chup-anh-quang-cao-my-pham-03.jpg'
                alt=''
              />
            </div>
