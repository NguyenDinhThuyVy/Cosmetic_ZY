          ...
          >
            <div className='flex flex-col'>
              ...
              <div className='flex flex-col gap-4 mt-8'>
                <div className='flex gap-2 mb-15 w-full item-center  '>
                  <div className='mr-20 size-18 text-center'>5</div>
                  <div className='w-[200px] mr-10'>
                    <div className='relative w-full box-border m-0 p-0 leading-snug'>
                      <div className='m-0 p-0  w-[200px]'>
                        <div className='h-[5px] bg-[#dfdfdf] align-middle overflow-hidden rounded-[100px] w-[200px]'>
                          <div
                            className='ant-progress-bg flex items-center'
                  ...
                  <div className='size-16 text-center'>(8)</div>
                </div>
              </div>
            </div>
            <div></div>
