            ...
            <div className='w-[780px] text-[14px]'>
              ...
              {!showAllContent ? (
                <button
                  ...
                  className='mt-4 text-black text-center font-bold py-2 px-4 rounded mb-20'
                >
                  Xem thêm
                </button>
              ) : (
                <button onClick={handleHideContent} className='mt-4 text-black text-center font-bold py-2 px-4 rounded'>
                  Ẩn bớt
                </button>
              )}
            </div>
