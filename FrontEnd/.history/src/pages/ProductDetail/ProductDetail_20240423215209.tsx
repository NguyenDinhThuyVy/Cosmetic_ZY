        ...
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          <div className='grid gap-24 mt-[50px]' style={{ gridTemplateColumns: '30% 70%' }}>
            ...
            <div className='w-[780px] text-[14px]'>
              <div className='content' style={{ height: showAllContent ? 'auto' : '200px', overflow: 'hidden' }}>
                <div id='iaat'>
                  <p id='iwj1'>
                    <em id='i46l'>
              ...
              {!showAllContent ? (
                <button
                  ...
                  className='mt-[-30px] text-black bg-white/80 p-8 font-bold rounded mb-20 w-[780px]'
                >
                  Xem thêm
                </button>
              ) : (
