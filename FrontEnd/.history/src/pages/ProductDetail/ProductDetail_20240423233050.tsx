            ...
            <div className=' w-[90%] text-[14px]'>
              ...
              {!showAllContent ? (
                <button
                  ...
                  className='mt-[-90px] text-black bg-gradient-to-t from-white via-white to-white/50 p-16 font-bold  w-[840px] text-[16px]'
                >
                  Xem thêm
                </button>
              ) : (
                <button
                  ...
                  className='mt-4 text-black text-center font-bold text-[16px] w-[840px]'
                >
                  Ẩn bớt
                </button>
              )}
