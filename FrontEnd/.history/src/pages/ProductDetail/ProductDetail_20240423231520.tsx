      ...
      <div className=' min-h-32'>
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          >
            ...
            <div className='flex flex-col gap-2  border-white border-b-gray-100 border-2 pb-4 w-[780px]'>
              <div className='flex flex-col text-[14px]'>
                ...
                <div className='flex gap-3 mt-2'>
                  ...
                  <p>Dưỡng ẩm và giảm kích ứng da khá tốt, bôi lên cảm giác mát, da căng bóng, dùng kèm với retinol</p>
                </div>
              </div>
            </div>
          </div>
