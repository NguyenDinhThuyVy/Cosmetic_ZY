        ...
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          <div className='grid gap-24 mt-[50px]' style={{ gridTemplateColumns: '30% 70%' }}>
            ...
            <div className='w-[780px] text-[14px]'>
              <div className='content' style={{ height: showAllContent ? 'auto' : '180px', overflow: 'hidden' }}>
                <div id='iaat'>
                  <p id='iwj1'>
                    <em id='i46l'>
              ...
              {!showAllContent ? (
                <button
                  ...
                  className='mt-[-100px] text-black bg-gradient-to-t from-rose-300/90 to-rose-500/90 p-16 font-bold  w-[780px]'
                >
                  Xem thêm
                </button>
              ) : (
                <button onClick={handleHideContent} className='mt-4 text-black text-center font-bold '>
                  Ẩn bớt
                </button>
              )}
            </div>
