      ...
      <div className=' min-h-32'>
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          >
            ...
            <div className='flex flex-col gap-2  border-white border-b-gray-100 border-2 pb-4'>
              <div className='flex flex-col text-[14px]'>
                <span>mon</span>
                <div className='flex gap-5 '>
                  <div className='flex gap-1 text-orange-500 text-[13px] pr-3 mt-2'>
                    <FaStar />
                    <FaStar />
                    <FaStar />
                    <FaStar />
                  ...
                  <div className='flex justify-center'>17/04/2023</div>
                </div>
              </div>
            </div>
          </div>
