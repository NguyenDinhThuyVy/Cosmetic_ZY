            ...
            <div className='w-[780px] text-[14px]'>
              <div className='content' style={{ height: showAllContent ? 'auto' : '250px', overflow: 'hidden' }}>
                <div id='iaat'>
                  ...
                  {!showAllContent ? (
                    <button onClick={handleShowMore} className='mt-4 text-black font-bold py-2 px-4 rounded mb-20'>
                      Xem thêm
                    </button>
                  ) : (
                    <button onClick={handleHideContent} className='mt-4 text-black font-bold py-2 px-4 rounded'>
                      Ẩn bớt
                    </button>
                  )}
                </div>
