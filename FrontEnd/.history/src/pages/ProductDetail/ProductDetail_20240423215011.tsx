        ...
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          <div className='grid gap-24 mt-[50px]' style={{ gridTemplateColumns: '30% 70%' }}>
            ...
            <div className='w-[780px] text-[14px]'>
              <div className='content' style={{ height: showAllContent ? 'auto' : '250px', overflow: 'hidden' }}>
                <div id='iaat'>
                  <p id='iwj1'>
                    <em id='i46l'>
              ...
              {!showAllContent ? (
                <button onClick={handleShowMore} className='mt-4 text-black bg-rose-300 p-10 font-bold rounded mb-20'>
                  Xem thêm
                </button>
              ) : (
