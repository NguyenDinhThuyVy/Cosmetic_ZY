...
export default function Profile() {
  ...
  return (
    <div className='rounded-sm bg-gray-100 px-2 pb-10 shadow md:px-7 md:pb-20 font border border-gray-200'>
      ...
      <form className='mt-8 flex flex-col-reverse md:flex-row md:items-start' onSubmit={onSubmit}>
        <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
          ...
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <button
                className='flex h-9 items-center rounded-md bg-rose-400 px-5 text-center text-sm text-white hover:bg-rose-400/80'
                type='submit'
              >
                Lưu
              </button>
