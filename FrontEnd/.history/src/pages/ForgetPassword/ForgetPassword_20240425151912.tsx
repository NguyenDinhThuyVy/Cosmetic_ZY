    ...
    <div className='w-full'>
      <div className=''>
        <div className='max-w-7xl mx-auto px-4 '>
          <div className=' py-12 lg:py-32 lg:pr-10 flex items-center'>
            <div className='lg:col-span-2 lg:col-start-4 w-[60%] '>
              <form
                className='p-10 rounded border-2 border-gray-100 rounded-lg  shadow-sm'
