      ...
      <div className=' h-[683px] '>
        <div className='max-w-6xl mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-5 py-8 lg:py-14 lg:pr-10 bg-white border rounded-xl '>
            <div className='lg:col-span-2 lg:col-start-1 px-6'>
              <img
            ...
            <form
              className='p-10  border-2 border-gray-100 rounded-lg  shadow-sm lg:col-span-3 lg:col-start-4 place-content-center'
