...
export default function Forgetpassword() {
  ...
  return (
    <div className='w-full my-4 mx-20 flex items-center'>
      <div className=''>
        <div className=' '>
          <div className=' py-12 lg:py-32 lg:pr-10 flex item-center w-full '>
            <div className='flex item-center  w-full '>
              <form
                className='p-10  border-2 border-gray-100 rounded-lg  shadow-sm w-[40%]'
