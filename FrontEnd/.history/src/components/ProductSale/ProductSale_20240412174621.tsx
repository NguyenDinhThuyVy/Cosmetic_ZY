...
export default function ProductSale() {
  return (
    <Link to='/' className='p-20'>
      <div className='bg-white shadow rounded-sm hover:translate-y-[-0.04rem] hover:shadow-md duration-100 transition-transform overflow-hidden w-[262px] h-[453x] flex flex-col'>
        <img src='https://cf.shopee.vn/file/ea0f159f3f4c713abcf56b5ba73840b9_tn' className='flex-1' alt='' />
