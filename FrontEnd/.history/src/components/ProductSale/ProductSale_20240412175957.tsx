...
export default function ProductSale() {
  return (
    <Link to='/' className='p-20'>
      <div className='bg-white shadow rounded-sm hover:translate-y-[-0.04rem] hover:shadow-md duration-100 transition-transform overflow-hidden w-[262px]  flex flex-col'>
