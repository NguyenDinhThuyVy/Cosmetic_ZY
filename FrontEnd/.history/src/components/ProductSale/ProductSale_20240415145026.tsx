            ...
            <div className='relative'>
              ...
              <div className='ant-progress ant-progress-line ant-progress-status-normal ant-progress-default'>
                <div className='ant-progress-outer'>
                  <div className='ant-progress-inner' style='background-color: rgba(199, 49, 48, 0.314);'>
                    <div
                      className='ant-progress-bg'
                      style='width: 21.6667%; height: 20px; background: repeating-linear-gradient(-45deg, rgba(199, 49, 48, 0.6), rgba(199, 49, 48, 0.6) 10px, rgb(199, 49, 48) 10px, rgb(199, 49, 48) 20px);'
                    ></div>
                  </div>
                </div>
              </div>
