    ...
    <Link to='/' className='group  bg-rose-300  w-[263px] h-[422px] p-5'>
      <div className=' bg-[#ffffff] flex flex-col justify-between gap-5 items-center rounded-2xl'>
        <div className='flex-1 h-1/2 w-full relative'>
          ...
          />
          <button className='absolute top-1/2 left-1/2 translate-x-[-50%] và translate-y-[-50%] hidden  group-hover:block bg-[#121010b6] text-gray-100 p-3 font-bold rounded-full hover:bg-gradient-to-r from-[#f0a80edb] via-[#c43131] to-[#671f57]'>
            Xem Chi Tiết
          </button>
        </div>
