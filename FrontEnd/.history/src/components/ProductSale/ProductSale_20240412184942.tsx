        ...
        <div className='flex-1 h-1/2 '>
          <div className='flex flex-col gap-2 items-center justify-center px-6'>
            ...
            <div className='text-[13px] flex gap-3'>
              ...
              <div class='relative'>
                <div class='inline-block relative bg-red-600 text-red-600 font-semibold font-sans rounded-l-md px-5 py-0.5'>
                  <span class='relative z-10'>11%</span>
                </div>
                <div class='absolute bg-red-600 w-0.5 h-0.5 top-0 left-0 transform rotate-45 origin-top-left'></div>
              </div>
            </div>
          </div>
        </div>
