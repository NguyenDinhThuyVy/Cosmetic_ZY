...
export default function ProductSale() {
  ...
  return (
    <div className='relative h-full group'>
      ...
      <button
        className='absolute top-1/3 left-[42%] translate-x-[-50%] và translate-y-[-50%] hidden  group-hover:block bg-[#121010b6] text-gray-100 px-4 py-3 font-bold rounded-full hover:bg-gradient-to-r from-[#f0a80edb] via-[#c43131d8] to-[#671f57d1]'
        onClick={showModal}
      >
        Xem Nhanh
      </button>
