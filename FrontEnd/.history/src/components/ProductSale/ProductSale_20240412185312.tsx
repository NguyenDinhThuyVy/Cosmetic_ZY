          ...
          <div className='flex flex-col gap-2 items-center justify-center px-6'>
            ...
            <div className='text-[13px] flex gap-3'>
              ...
              <div className='relative w-24 h-12 overflow-hidden'>
                {/* Rocket */}
                <div className='absolute left-0 bg-red-600 w-24 h-12 transform rotate-45 origin-left'></div>
                {/* Text */}
                <div className='absolute left-0 w-24 h-12 flex justify-center items-center z-10'>
