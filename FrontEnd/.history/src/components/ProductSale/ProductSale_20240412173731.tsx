...
export default function ProductSale() {
  return (
    <Link to='/' className='p-20'>
      <div className='bg-white shadow rounded-sm hover:translate-y-[-0.04rem] hover:shadow-md duration-100 transition-transform overflow-hidden w-[280px] h-[453x]'>
        <div className='w-full pt-[100%] relative h-1/3'>
          <img
            src='https://cf.shopee.vn/file/ea0f159f3f4c713abcf56b5ba73840b9_tn'
            alt=''
            className='absolute top-0 left-0 bg-white h-1/3 object-cover'
          />
        </div>
        <div className='p-2 overflow-hidden h-2/3'>
