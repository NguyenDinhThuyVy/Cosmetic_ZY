  ...
  return (
    <>
      <Swiper
        ...
        className=' w-full text-sm h-[415px]'
      >
        <SwiperSlide>
        ...
        <SwiperSlide>
          <img src='https://image.hsv-tech.io/987x0/bbx/common/d148fec5-c7f0-4a94-aaf7-27e6124b31de.webp' alt='' />
        </SwiperSlide>
        <SwiperSlide>
          <img src='https://image.hsv-tech.io/987x0/bbx/common/2a92db11-227b-4579-8696-7be2f14bc782.webp' alt='' />
        </SwiperSlide>
      </Swiper>
    </>
  )
