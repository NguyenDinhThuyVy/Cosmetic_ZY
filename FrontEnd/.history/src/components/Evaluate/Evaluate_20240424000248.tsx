...
export default function Evaluate() {
  return (
    <div className='px-4 py-3'>
      ...
      <div className='flex  items-center  justify-center border-2 rounded-full w-[150px] h-[48px] bg-gradient-to-r from-[#f0a80e] via-[#c43131] to-[#671f57] text-white text-base  '>
        <button
          type='button'
          className='ant-btn ant-btn-primary size-16  flex-1 btn-black h-50 radius-38 pd-14-23 flex-center btn-add-cart uppercase'
        >
          Gửi Cho Chúng Tôi
        </button>
      </div>
