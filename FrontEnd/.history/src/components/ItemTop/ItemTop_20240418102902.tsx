    ...
    <Link to='/' className='group h-[419px]'>
      <div className=' w-[260px] flex flex-col justify-between gap-5 items-center rounded-2xl shadow-gray-400/90 group-hover:shadow-lg '>
        <div className='flex-1 h-1/2  relative '>
          ...
          />
          <button
            className='absolute top-1/2 left-1/2 translate-x-[-50%] và translate-y-[-50%] hidden  group-hover:block bg-[#121010b6] text-gray-100 px-4 py-3 font-bold rounded-full hover:bg-gradient-to-r from-[#f0a80edb] via-[#c43131d8] to-[#671f57d1] animate-ping'
            onClick={showModal}
          >
            Xem Nhanh
          </button>
