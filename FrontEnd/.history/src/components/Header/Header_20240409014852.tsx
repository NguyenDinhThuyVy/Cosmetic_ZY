  ...
  return (
    <header>
      <div className='flex p-4 items-center gap-5'>
        ...
        <div className='flex gap-5 items-center w-2/5 justify-between'>
          ...
          <div className='flex-grow-1'>
            <div className='flex flex-wrap gap-3'>
              ...
              <div className='flex flex-col justify-center'>
                ...
                <span className='text-gray-500 text-xs '>Đăng Nhập</span>
              </div>
            </div>
          </div>
          <div className='flex-grow-1'>
            <Link to='/'>
              {' '}
              <div className='flex flex-wrap gap-3 border-2 border-orange-400 rounded-lg p-2'>
                <img
                  src='https://bizweb.dktcdn.net/100/426/076/themes/896300/assets/cart_icon.png?1692086228721'
                  alt=''
                  className='h-[18px] w-[18px] '
                />
                <span className='relative  '> Giỏ hàng</span>
              </div>
            </Link>
          </div>
        </div>
