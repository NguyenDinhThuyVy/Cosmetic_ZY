      ...
      <div className='flex py-5 px-8  items-center gap-12 justify-center'>
        ...
        <div className='flex gap-8 items-center w-3/5 '>
          <div className='flex-grow-1'>
            <div className='flex flex-wrap gap-2 items-center text-orange-500'>
              <svg width='30' height='30' viewBox='0 0 30 29' fill='#e6677c' xmlns='http://www.w3.org/2000/svg'>
                <path
              ...
              <span className='text-gray-500 font-semibold text-base hover:text-red-400'>Hệ Thống Cửa Hàng</span>
            </div>
          </div>
          <div className='flex-grow-1'>
