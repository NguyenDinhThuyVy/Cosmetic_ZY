            ...
            <div className='flex flex-wrap gap-3'>
              ...
              {isAuthenticated && (
                <div className='flex flex-col justify-center mt-1'>
                  <span className='text-gray-500'>Hi !Thuy Vy</span>
              ...
              {!isAuthenticated && (
                <div className='flex flex-col justify-center mt-1 '>
                  ...
                  <div className='flex flex-wrap gap-1'>
                    <Link to='/login'>
                      <span className='text-gray-500 text-xs hover:text-red-400 mt-2'>Đăng Nhập </span>
                    </Link>
                    <span className='text-gray-500 text-sm'>|</span>
                    <Link to='/register'>
                      <span className='text-gray-500 text-xs hover:text-red-400  mt-2'>Đăng Ký </span>
                    </Link>
                  </div>
                </div>
              )}
