...
function Header() {
  return (
    <header>
      <div className='flex py-5 px-8 items-center gap-10'>
        ...
        <div className='flex gap-5 items-center w-3/5 '>
          ...
          <div className='flex-grow-1'>
            <div className='flex flex-wrap gap-2 border-2 text-gray-600  border-orange-400 rounded-lg p-2 py-1 hover:text-gray-300 cursor-pointer'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
