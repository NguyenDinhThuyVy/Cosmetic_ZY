      ...
      <div className='flex py-5 px-8  items-center gap-12 justify-center'>
        ...
        <div className='flex gap-8 items-center w-3/5 '>
          <div className='flex-grow-1'>
            <Link to='/'>
              {' '}
              <div className='flex flex-wrap gap-2 items-center text-red-400'>
                <FaPhone />
                <div className='flex flex-col gap-1 justify-center items-center'>
                  <span className='text-gray-500 font-semibold text-sm '>Hỗ trợ khách hàng</span>
                  <span className='text-gray-500 font-semibold text-sm '>090.199.6468</span>
                </div>
              </div>
            </Link>
          </div>
