              ...
              <div className='flex gap-4'>
                <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex gap-4 text-white text-3xl '>
                    <Link to='/'>
                      <FaFacebookF className='hover:bg-rose-300 border rounded-full border-white p-[5px]' />
                    </Link>
                    <Link to='/'>
                      <FaTwitter className='hover:bg-rose-300 border rounded-full border-white p-1' />
                    </Link>
                    <Link to='/'>
                      <IoLogoGoogle className='hover:bg-rose-300 border rounded-full border-white p-1' />
                    </Link>
                    <Link to='/'>
                      <PiInstagramLogoBold className='hover:bg-rose-300 border rounded-full border-white p-1' />
                    </Link>
                    <Link to='/'>
                      <IoLogoYoutube className='hover:bg-rose-300 border rounded-full border-white p-1' />
                    </Link>
                  </div>
                </div>
              </div>
