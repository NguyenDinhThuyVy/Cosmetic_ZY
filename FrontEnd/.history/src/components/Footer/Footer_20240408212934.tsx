              ...
              <div className='flex gap-4'>
                <div className='flex flex-col gap-4'>
                  ...
                  <div className='flex gap-4 text-white text-3xl'>
                    <Link to='/'>
                      <FaFacebookF className='hover:bg-rose-300 border rounded-full border-white p-5' />
                    </Link>
                    <Link to='/'>
                      <AiFillTwitterCircle className='hover:text-rose-300' />
                    </Link>
                    <Link to='/'>
                      <AiFillGoogleCircle className='hover:text-rose-300' />
                    </Link>
                    <Link to='/'>
                      <FaFacebookF className='hover:text-rose-300' />
                    </Link>
                    <Link to='/'>
                      <FaFacebookF className='hover:text-rose-300' />
                    </Link>
