...
function Footer() {
  return (
    <footer className='background-image: url("//bizweb.dktcdn.net/100/336/334/themes/939194/assets/bg_cosmetics.jpg?1706112573342")'>
      <div className='mid-footer'>
        <div className='container'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            <div className='col-span-1'>
              <div className='logo_footer mb-6'>
              ...
              <div className='widget-ft-top mb-6'>
                ...
                <div>
                  <div className='widget-ft'>
                    <h4 className='title-menu'>
                      ...
                      >
                        Hỗ trợ khách hàng <i className='fa fa-plus' aria-hidden='true'></i>
                      </button>
                    </h4>
        ...
        <div className='container'>
          <div className='inner'>
            <p className='w-full text-center'>
              © Bản quyền thuộc về <b>Cool Team</b>. Cung cấp bởi{' '}
              <a
