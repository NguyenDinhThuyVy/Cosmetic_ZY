...
export default function UserSideNav() {
  return (
    <div className=' border border-gray-200 rounded-lg w-full px-4 pb-6 bg-gray-100 font'>
      ...
      <div className='mt-7'>
        <Link to={path.profile} className='flex items-center capitalize text-gray-800 transition-colors'>
        ...
        <Link
          ...
          className='mt-4 flex items-center capitalize text-[14px]  text-gray-800 transition-colors'
        >
