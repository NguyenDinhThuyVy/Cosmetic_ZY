    ...
    <div className='grid gap-5' style={{ gridTemplateColumns: '45% 55%' }}>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2'>
          <div className='flex gap-1 text-orange-500 items-center justify-center text-[13px]'>
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStarHalfAlt />
            <span className='text-black ml-2 text-[13px]  border-white border-r-gray-200 border-2 pr-3'>(10)</span>
          </div>
