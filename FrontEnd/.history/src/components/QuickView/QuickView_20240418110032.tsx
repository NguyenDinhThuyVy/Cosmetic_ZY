        ...
        <div className='flex gap-2 mt-3'>
          <div className=''>
            <div className='flex  items-center justify-center'>
              <button
                type='button'
                className='border-2 border-gray-200 flex items-center px-3 w-[40px] h-[50px] rounded-l-full border-r-indigo-500'
              >
              ...
              <div className='bg-gray-300 flex items-center px-3 w-[40px] h-[50px] '>2</div>
