    ...
    <div className='grid gap-5' style={{ gridTemplateColumns: '45% 55%' }}>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='relative'>
          <div className='absolute inset-0 bg-gradient-to-r from-[#f0a80edb] via-[#c43131d8] to-[#671f57d1] border-2 border-transparent'></div>
          <div className='relative p-[2px]'>hihi</div>
        </div>
      </div>
    </div>
  )
