    ...
    <div className='grid gap-5' style={{ gridTemplateColumns: '45% 55%' }}>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2 mt-3'>
          <div className=''>
            <div className='flex  items-center justify-center border-2 border-gray-300 rounded-l-full'>
              <button
                type='button'
                className='border-2 border-gray-200 flex items-center px-3 w-[40px] h-[50px] rounded-l-full border-r-white bg bg-red-700'
              >
              ...
              <div className=' border-2 border-gray-300 flex items-center px-3 w-[40px] h-[49px] text-base font-bold border-r-white  border-l-white'>
                2
              </div>
              <button
                type='button'
                className='flex items-center px-3 w-[40px] h-[50px] rounded-r-full border-2 border-gray-200 border-l-white  bg-red-700'
              >
                <span role='img' className='anticon'>
