...
export default function QuickView() {
  return (
    <div classNameName='grid gap-5' style={{ gridTemplateColumns: '45% 55%' }}>
      <div classNameName=''>
        <SwiperQuick />
      </div>
      <div classNameName='flex flex-col gap-1'>
        <div classNameName='text-l text-rose-700 uppercase font-bold'>ahc</div>
        <div classNameName='text-xl text-gray-900  font-bold'>
          Kem Dưỡng Ẩm, Phục Hồi Da AHC Premium Ex Hydra B5 Biome Capsule Cream 50ml
        </div>
        <div classNameName='flex gap-2'>
          <div classNameName='flex gap-1 text-orange-500 items-center justify-center text-[13px] border-white border-r-gray-200 border-2 pr-3'>
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStar />
            <FaStarHalfAlt />
            <span classNameName='text-black ml-2 text-[13px]'>(10)</span>
          </div>
          <div classNameName='flex gap-1  border-white border-r-gray-200 border-2 pr-3'>
            <span classNameName='font-semibold'>Xuất sứ :</span>
            <span>Hàn Quốc</span>
          </div>
          <div classNameName='flex gap-1'>
            <span classNameName='font-semibold'>Mã:</span>
            <span>5044</span>
          </div>
        </div>
        <div classNameName='border-gradient w-[92%] rounded-lg p-2 mt-2 flex flex-col gap-1 '>
          <div classNameName='font-bold text-[15px]'>Thông tin sản phẩm :</div>
          <p classNameName='line-clamp-6'>
        ...
        <div classNameName='flex gap-2 mt-3'>
          <div classNameName='flex  items-center justify-center border-2 border-gray-200 rounded-full'>
            <button
              type='button'
              classNameName=' flex items-center px-3 w-[40px] h-[45px] rounded-l-full hover:bg-gray-200 '
            >
              <span role='img' classNameName='anticon'>
            ...
            <div classNameName=' flex items-center px-3 w-[40px] h-[45px] text-base font-bold justify-center'>2</div>
            <button
              type='button'
              classNameName='flex items-center px-3 w-[40px] h-[45px] rounded-r-full hover:bg-gray-200 '
            >
              <span role='img' classNameName='anticon'>
