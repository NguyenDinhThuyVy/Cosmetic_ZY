  ...
  return (
    <div className='grid gap-5' style={{ gridTemplateColumns: '45% 55%' }}>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2'>
          <div className=''>
            <div className='flex-center h-50 flex gap-1 items-center'>
              <button type='button' className='ant-btn ant-btn-text ant-btn-sm ant-btn-icon-only quantity-btn min-btn'>
              ...
              <div className='quantity-text w-50 text-center size-l flex-center'>2</div>
              <button type='button' className='ant-btn ant-btn-text ant-btn-sm ant-btn-icon-only quantity-btn add-btn'>
                <span role='img' className='anticon'>
