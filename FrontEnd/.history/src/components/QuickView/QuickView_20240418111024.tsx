        ...
        <div className='flex gap-2 mt-3'>
          <div className=''>
            <div className='flex  items-center justify-center border-2 border-gray-300 rounded-full'>
              ...
              <div className=' flex items-center px-3 w-[40px] h-[49px] text-base font-bold justify-center'>2</div>
              <button type='button' className='flex items-center px-3 w-[40px] h-[50px] rounded-r-full  bg-red-700'>
                <span role='img' className='anticon'>
