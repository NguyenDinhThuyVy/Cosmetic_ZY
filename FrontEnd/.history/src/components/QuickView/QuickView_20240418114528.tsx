      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2 mt-3'>
          ...
          <div>
            ...
            <div className='flex  items-center  justify-center border-2 rounded-full w-[185px] h-[48px] bg-gradient-to-r from-[#f0a80e] via-[#c43131] to-[#671f57] text-white text-base '></div>
          </div>
        </div>
      </div>
    </div>
