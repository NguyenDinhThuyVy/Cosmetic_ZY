        ...
        <div className='flex gap-2 mt-3'>
          <div className=''>
            <div className='flex  items-center justify-center'>
              <button
                type='button'
                className='border-2 border-gray-200 flex items-center px-3 w-[40px] h-[50px] rounded-l-full border-r-white'
              >
              ...
              <div className=' border-2 border-gray-20 flex items-center px-3 w-[40px] h-[50px] border-r-white border-l-white '>
                2
              </div>
              <button type='button' className='bg-gray-300 flex items-center px-3 w-[40px] h-[50px] rounded-r-full'>
                <span role='img' className='anticon'>
