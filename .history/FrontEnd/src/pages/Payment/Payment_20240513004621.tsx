  ...
  const ButtonWrapper = ({ showSpinner }) => {
    ...
    return (
      <>
        ...
        <PayPalButtons disabled={false} forceReRender={[style]} fundingSource={undefined} onClick={onClick} />
      </>
    )
  }
  return (
              ...
              <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5'>
                ...
                <div>
                  <input
                    ...
                    name='paymentMethod'
                    value='cash'
                    onChange={() => {setPayment((prevPayment) => ({ ...prevPayment, paymentMethod: 0 }))   setIsPayPalSelected(false)}}
                  />
