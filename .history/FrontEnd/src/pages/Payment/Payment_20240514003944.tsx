            ...
            <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5 w-full'>
              <div className='mt-[20px]'>
                ...
                {payment.paymentMethod === 1 ? (
                  <p className='pt-[10px] text-[13px]  text-center'>Số tiền đã thanh toán : {payment.totalMoney}</p>
                ) : (
                  <p className='pt-[10px] text-[13px]  text-center'>Chuẩn bị số tiền mặt : {payment.totalMoney}</p>
                )}
