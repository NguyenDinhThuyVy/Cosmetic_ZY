    ...
    <div>
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 m-5 font'>
        <div className='flex flex-col border-2 border-gray-100 rounded-lg p-3'>
          <span>Số lượng mặt hàng đã mua</span>
          <table className='table-auto w-full mt-5'>
            <thead>
              <tr>
                <th className='px-4 py-2 text-center'>Ảnh</th>
                <th className='px-4 py-2 text-center w-[50%]'>Tên sản phẩm</th>
                ...
                <>
                  <tr>
                    <td className='px-4 py-2 text-center'>
                      <Image width={100} src={Item.product.image} style={{ borderRadius: '5px' }} />
                    </td>
