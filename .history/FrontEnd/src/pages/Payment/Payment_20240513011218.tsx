...
export default function Payment({ checkedPurchases, totalCheckedPurchasePrice }: Props) {
  ...
  function onApprove() {
    ...
    return Promise.resolve() // Trả về một promise không giữa
  }
  const ButtonWrapper = ({ showSpinner }) => {
    const [{ isPending }] = usePayPalScriptReducer()
    // const totalPayment = totalCheckedPurchasePrice
    return (
      <>
                  ...
                  {isPayPalSelected && (
                    <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5 h-[400px] w-full'>
                      ...
                      <div style={{ maxWidth: '750px', minHeight: '200px' }}>
                        <PayPalScriptProvider options={{ clientId: 'test', components: 'buttons', currency: 'VND' }}>
