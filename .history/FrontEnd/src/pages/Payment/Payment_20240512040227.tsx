      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 m-5'>
        <div className='flex flex-col'>
          <div className='flex justify-between'>
            <img
              src='https://image.made-in-china.com/2f0j00HsUiftBERezR/Pet-Accessories-Clothing-Green-Shrek-Hat-Funny-Wool-Hand-Knitted-Ruffian-Net-Red-Cat-Cute-Headgear.webp'
              alt=''
            />
          </div>
        </div>
