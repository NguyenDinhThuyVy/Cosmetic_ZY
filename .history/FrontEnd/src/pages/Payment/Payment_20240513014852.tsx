...
export default function Payment({ checkedPurchases, totalCheckedPurchasePrice }: Props) {
  ...
  console.log(isPayPalButtonSuccess)
  ...
  console.log(isPayPalSelected)

  function onApprove(data, actions) {
    setIsPayPalButtonSuccess(true)
    setPayment((prevPayment) => ({ ...prevPayment, paymentMethod: 1 }))
    console.log(totalCheckedPurchasePrice)
    return actions.order.create({
      purchase_units: [
        {
          amount: {
            value: totalCheckedPurchasePrice, // Giá trị thanh toán
            currency_code: 'USD' // Mã tiền tệ (USD, EUR, v.v.)
          }
        }
      ]
    })
  ...
  const ButtonWrapper = ({ showSpinner }) => {
    ...
    return (
      <>
        ...
        <PayPalButtons disabled={false} forceReRender={[style]} fundingSource={undefined} onApprove={onApprove} />
      </>
    )
  }
  return (
            ...
            <div className='flex gap-3'>
              <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5'>
                ...
                <div>
                  ...
                  {isPayPalSelected && (
                    <div className='flex flex-col gap-4 border-2 border-gray-100 rounded-lg p-5 h-[200px] w-full'>
                      {/* <PayPalButton
                      ...
                      /> */}
                      <div style={{ maxWidth: '750px', maxHeight: '200px' }}>
