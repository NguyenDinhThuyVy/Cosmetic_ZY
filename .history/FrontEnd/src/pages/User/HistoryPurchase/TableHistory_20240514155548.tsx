...
export default function TableHistory() {
  ...
  if (paymentData) {
    ...
    const purchase: any = datapayment.purchase
    ...
    return (
      <>
        ...
        >
          <div className='flex flex-col border-2 border-gray-100 rounded-lg p-4'>
            ...
            {payment
              ...
              .map((filteredPayment: any) => (
                <div key={filteredPayment._id} className='px-2 flex flex-col gap-3'>
                  <span className='text-start text-[14px] font-semibold '>
                    Tên khách hàng: <span className='font-medium'>{filteredPayment.name}</span>{' '}
                  </span>
                  <span className='text-start text-[14px] font-semibold '>Tên khách hàng: {filteredPayment.name}</span>
                </div>
              ))}
