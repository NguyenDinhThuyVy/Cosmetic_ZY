      ...
      <>
        ...
        >
          <div className='flex flex-col border-2 border-gray-100 rounded-lg p-4'>
            ...
            {payments.filter(payment => payment._id === selectedId).map((filteredPayment) => (
            <div key={filteredPayment._id}>
              <span className='text-start text-[16px] font-bold uppercase'>
                Tên khách hàng: {filteredPayment.customerName}
              </span>
              {/* Bổ sung thêm thông tin khác nếu cần */}
            </div>
          ))} */}
