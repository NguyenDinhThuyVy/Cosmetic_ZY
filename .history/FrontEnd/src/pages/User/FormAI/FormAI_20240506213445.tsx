  ...
  return (
    <div className='rounded-md bg-white px-2 pb-10 shadow md:px-7 md:pb-20 font '>
      <div className='border-b border-b-gray-200 py-6 relative'>
        ...
        <div className='absolute top-0 right-0 translate-x-[30%] và translate-y-[-40%]   text-gray-100 px-4 py-3 font-bold rounded-full bg-gradient-to-r from-[#f0a80edb] via-[#c43131d8] to-[#671f57d1] w-[50px] h-[50px]'>
          Mới
        </div>
      </div>
    </div>
