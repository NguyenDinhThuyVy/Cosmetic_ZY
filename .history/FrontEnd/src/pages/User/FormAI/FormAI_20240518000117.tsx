import { Button, ConfigProviderProps, Form, Input, Modal, Select, SelectProps } from 'antd'
      ...
      >
        <div className='flex flex-col border-2 border-gray-100 rounded-lg p-4 font'>
          ...
          <div className='px-2 flex flex-col gap-3'>
            ...
            <div className='flex gap-6'>
              <span className='text-start text-[14px] font-semibold '>
                Số điện thoại: <span className='font-normal'>09055</span>{' '}
              </span>
              <span className='text-start text-[14px] font-semibold '>
                Địa chỉ: <span className='font-normal'>232</span>{' '}
              </span>
              <span className='text-start text-[14px] font-semibold '>
            ...
            <div className='flex gap-[54px]'>
              <span className='text-start text-[14px] font-semibold '>
                Số lượng mặt hàng: <span className='font-normal'>255</span>{' '}
              </span>
              <span className='text-start text-[14px] font-semibold '>
                Tổng tiền thanh toán: <span className='font-normal'>55</span>{' '}
              </span>
            </div>
          </div>
              ...
              <>
                <tr>
                  <td className='px-4 py-2 text-center'>
                    <Image width={80} src='' style={{ borderRadius: '5px' }} />
                  </td>
