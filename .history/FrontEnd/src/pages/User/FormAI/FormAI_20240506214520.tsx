  ...
  return (
    <div className='rounded-md bg-white px-2 pb-10 shadow md:px-7 md:pb-20 font '>
      <div className='border-b border-b-gray-200 py-6 relative'>
        ...
        <div className='flex gap-2 w-full border border-gray-200 p-4 rounded-lg'>
          <div className='mt-3  flex flex-col gap-6 item-center'>
          ...
          <div className='w-full flex items-center justify-center'>
            <button className=' w-full h-[120px] text-gray-100  font-bold rounded-full bg-gradient-to-r from-[#f0a80edb] via-[#c43131d8] to-[#671f57d1]'>
              <img src='https://go4customer.com/images/blog/SIMPLE%20CHATBOTS.png' alt='' />
            </button>
          </div>
        </div>
