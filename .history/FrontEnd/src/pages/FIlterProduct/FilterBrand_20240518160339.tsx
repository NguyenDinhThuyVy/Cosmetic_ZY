...
export default function FilterBrand() {
  ...
  const getBrandsbyID = async (id: string): Promise<SuccessResponse<Brand[]>> => {
    const response: AxiosResponse<SuccessResponse<Brand[]>> = await axios.get(`/admin/brands/${id}`)
  ...
  const { data: brandData } = useQuery<SuccessResponse<Brand[]>>({
    queryKey: ['brand', queryConfig],
    queryFn: () => getBrandsbyID(queryConfig.brand || ''),
    keepPreviousData: true,
    enabled: !!queryConfig.brand
  })
