  ...
  return (
    <div className='h-full flex flex-col font '>
      <div className='flex flex-col justify-center items-center gap-4'>
        ...
        <div className='w-[70%] ' style={{ height: showAllContent ? 'auto' : '100px', overflow: 'hidden' }}>
          <div id='iaat'>
            <p id='iwj1'>
              <em id='i46l'>
        ...
        {!showAllContent ? (
          ...
          <button onClick={handleHideContent} className='mt-4 text-black text-center font-bold text-[16px] w-[890px]'>
            Ẩn bớt
          </button>
        )}
      </div>
