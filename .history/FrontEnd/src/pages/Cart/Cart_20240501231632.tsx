        ...
        <div className=' product-list max-h-[600px] overflow-y-auto border-2 border-gray-100 rounded-lg'>
          <div className='cart-table-section '>
            <table className='table-shop'>
              ...
              <div  key={purchase._id}> <tbody>
              <tr>
                <td className='p-0 text-center'>
                  <input type='checkbox' checked={purchase.checked}
                                onChange={handleCheck(index)}></input>
                </td>
                <td className=''>
                  <div className='flex flex-row items-center gap-x-[10px]'>
                    <div className='relative'>
                      ...
                      <Popconfirm
                        ...
                        cancelText='No'
                      >
                        <button className='absolute top-[-15px] right-[-10px] z-40'     onClick={handleDelete(index)}>
                ...
                <td className='p-0 pl-6 '>
                  <div className='flex items-center gap-x-[10px]'>
                    <span className='line-through text-gray-400 '>{formatCurrency(purchase.product.price_before_discount)}</span>
