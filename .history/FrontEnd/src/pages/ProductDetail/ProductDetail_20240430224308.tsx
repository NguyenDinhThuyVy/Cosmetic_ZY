    ...
    <div className='h-full flex flex-col font '>
      <div className=' min-h-32'>
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          >
            <div className='grid gap-6 max-h-[500px]' style={{ gridTemplateColumns: '20% 80%' }}>
              <div className='relative  grid grid-rows-4 gap-1 h-[80%] '>
                <button className=' text-black text-[25px] text-center  ' onClick={prev}>
                  <HiChevronUp />
                </button>
                {currentImages.map((img) => {
                  ...
                  return (
                    <div
                      className=' flex flex-col gap-3 justify-center item-center mr-[20px] relative w-full  '
                      key={img}
                      onMouseEnter={() => chooseActive(img)}
                    >
                      <img src={img} alt={product?.name} className='cursor-pointer w-[100%] object-cover ' />
                      {isActive && <div className='absolute inset-0 border-2 border-gray-600' />}
                    </div>
                  )
                })}
                <button className=' text-black text-[25px] text-center flex justify-center ' onClick={next}>
                  <HiChevronDown />
                </button>
              </div>
              <div
                className='relative w-[400px] h-[80%] cursor-zoom-in overflow-hidden shadow rounded-lg'
              ...
              >
                <img
                  src={activeImage}
                  alt={product?.name}
                  className=' absolute top-0 left-0 h-[80%] w-full bg-white object-center rounded-lg'
                  ref={imageRef}
                />
              </div>
            </div>
            <div className='flex flex-col gap-2  w-[700px]'>
              ...
              <div className='text-[19px] text-left font-bold text-gray-700 w-[750px]'>
