            ...
            <div className='grid gap-5' style={{ gridTemplateColumns: '20% 80%' }}>
              <div className='flex flex-col gap-4 item-center justify-center '>
                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    <div
                      className=' flex flex-col gap-3 justify-center item-center mr-[20px] relative w-full pt-[100%]'
                      key={img}
              ...
              <div
                className='relative w-full cursor-zoom-in overflow-hidden pt-[100%] shadow rounded-lg'
