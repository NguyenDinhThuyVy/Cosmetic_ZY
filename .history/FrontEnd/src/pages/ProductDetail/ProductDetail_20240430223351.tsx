    ...
    <div className='h-full flex flex-col font '>
      <div className=' min-h-32'>
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          >
            <div className='grid gap-6 max-h-[500px] overflow-hidden' style={{ gridTemplateColumns: '20% 80%' }}>
              <div className='flex flex-col gap-4 item-center justify-center  '>
                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    ...
                    >
                      <img src={img} alt={product?.name} className='cursor-pointer w-[100%] object-cover h-[80%] ' />
