    ...
    <div className='h-full flex flex-col font '>
      <div className=' min-h-32'>
        <div className='flex flex-col gap-2 my-4 mx-20'>
          ...
          >
            <div className='grid gap-6 max-h-[400px]' style={{ gridTemplateColumns: '20% 80%' }}>
              <div className='relative  grid grid-rows-4 gap-3 h-[80%] '>
                <button className=' text-black text-[25px] text-center flex justify-center ' onClick={prev}>
                  <HiChevronUp />
                </button>
