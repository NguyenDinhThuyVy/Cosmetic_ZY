...
export default function ProductList() {
  ...
  const { mutate: mutateSortBy } = useMutation((sortByValue: Exclude<ProductListConfig['sort_by'], undefined>) => {
    return productApi.getProducts({ ...queryConfig, sort_by: sortByValue })
  })
  return (
