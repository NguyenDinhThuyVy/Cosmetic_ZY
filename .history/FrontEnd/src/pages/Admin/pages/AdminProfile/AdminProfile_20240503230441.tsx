      ...
      <form className='mt-2 flex flex-col gap-3 ' onSubmit={onSubmit}>
        ...
        <div className='mt-6 flex-grow md:mt-0 md:pr-12 w-[90%]'>
          ...
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row item-center w-full'>
            <div className='sm:pl-5 flex items-center  w-full'>
              <button
                className='text-white checkout-button  bg-gradient-to-r from-[#f0a80e] via-[#c43131] to-[#671f57] font-semibold w-full flex items-center'
                type='submit'
              >
                Lưu
              </button>
