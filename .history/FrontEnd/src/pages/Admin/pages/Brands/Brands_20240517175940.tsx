            ...
            <div className='text-[23px] font-semibold'>
              {currentBrandId ? (
                ...
                <div>
                  ...
                  <p>
                    Việc quý khách hàng tin tưởng và ủng hộ ZYMY COSMETIC không chỉ là một điều vô cùng quý giá mà còn
                    là động lực lớn lao giúp chúng tôi không ngừng nỗ lực, cải thiện và mang đến những sản phẩm chất
                    lượng, dịch vụ tốt nhất cho quý vị.
                  </p>
                  <p>
