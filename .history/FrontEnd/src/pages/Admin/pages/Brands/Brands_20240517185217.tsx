...
export default function Brands() {
  ...
  const { data: brandNumberData, refetch } = useQuery(
    ['brandData', currentBrandId], // key cho query là ['brandData', currentBrandId]
    () => adminApi.getProductByBrand(currentBrandId) // hàm fetchDataBrand sẽ được gọi khi cần thiết
  )
