        ...
        <div className='border border-gray-200 rounded-lg py-4 w-[60%] font'>
          <div className='flex flex-col justify-center items-center gap-4'>
            <div className='relative w-full '>
              <img src='https://image.hsv-tech.io/1920x0/bbx/common/b4d9bd4a-e2d8-4904-923d-ee063ba5c10d.webp' alt='' />
              <img
                src={
                  currentBrandId
                ...
                alt=''
                className='w-[120px] h-[120px] rounded-2xl border-2 border-gray-200 absolute top-[50%] left-[50%] '
              />
            </div>
