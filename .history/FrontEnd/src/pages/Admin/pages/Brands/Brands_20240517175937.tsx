  ...
  return (
    <div className='flex flex-col  gap-8 border border-gray-200 rounded-lg w-full px-4 pt-4    '>
      ...
      <div className='flex gap-6 '>
        ...
        <div className='border border-gray-200 rounded-lg py-4 w-[60%] font'>
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            <div className='text-[23px] font-semibold'>
              {currentBrandId ? `${brandData.data.data.name}` : ((
    <div>
      <p>
        Chúng tôi xin chân thành gửi lời cảm ơn sâu sắc đến quý khách hàng đã lựa chọn <strong>ZYMY COSMETIC</strong> là điểm đến cho nhu cầu làm đẹp của mình, thay vì bước vào thế giới sôi động và đa dạng của thị trường mỹ phẩm ngày nay.
      </p>
      <p>
        Việc quý khách hàng tin tưởng và ủng hộ ZYMY COSMETIC không chỉ là một điều vô cùng quý giá mà còn là động lực lớn lao giúp chúng tôi không ngừng nỗ lực, cải thiện và mang đến những sản phẩm chất lượng, dịch vụ tốt nhất cho quý vị.
      </p>
      <p>
        Chúng tôi cam kết sẽ không ngừng phấn đấu, đổi mới và nâng cao chất lượng sản phẩm cũng như dịch vụ để xứng đáng với sự tin yêu và ủng hộ của quý khách hàng.
      </p>
      <p>
        Một lần nữa, chân thành cảm ơn quý khách hàng đã lựa chọn <strong>ZYMY COSMETIC</strong> và hy vọng sẽ có nhiều cơ hội được phục vụ quý vị trong tương lai.
      </p>
    </div>
  );)}
            </div>
