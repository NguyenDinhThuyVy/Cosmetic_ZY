...
export default function Brands() {
  ...
  const {
    ...
    ['brands', currentBrandId], // Include the ID in the query key
    () => adminApi.getBrandsbyID(currentBrandId), // Pass the ID to the API function
    {
      enabled: !!currentBrandId // This ensures the query only runs when currentBrandId is not null
    }
  )
  return (
