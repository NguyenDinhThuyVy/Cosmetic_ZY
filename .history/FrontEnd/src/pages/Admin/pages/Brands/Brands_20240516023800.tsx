...
export default function Brands() {
  ...
  const { data: brandsData } = useQuery({
    queryKey: ['brandsID', queryConfig],
    queryFn: () => {
      return adminApi.getBrandsbyID(currentBrandId)
    }
  })
          ...
          <div className='flex flex-col justify-center items-center gap-4'>
            <div>
              <img
                src={
                  brandsData
                    ? 'https://image.hsv-tech.io/400x0/bbx/product-collections/[BRAND-SPECIFIC-IMAGE].webp'
                    : 'https://image.hsv-tech.io/400x0/bbx/product-collections/b12cbf2a-f20e-4020-bceb-25025e00459c.webp'
                }
                alt=''
