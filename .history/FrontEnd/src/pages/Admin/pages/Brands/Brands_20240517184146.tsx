...
export default function Brands() {
  ...
  const [brandNumberData, setBrandNumberData] = useState<any>(null)
  ...
  const fetchDataBrand = async () => {
    try {
      ...
      setBrandNumberData(productData)
    } catch (error) {
      console.error('Error fetching data:', error)
    }
  }
  console.log(brandNumberData.data.data.products.length)
  useEffect(() => {
    fetchData()
    fetchDataBrand()
  }, [currentBrandId])
        ...
        <div className='border border-gray-200 rounded-lg w-[60%] font'>
          <div className='flex flex-col justify-center items-center gap-4'>
            <div className='relative w-full mb-6'>
              <RandomImage
                imageList={[
                  'https://image.hsv-tech.io/1920x0/bbx/common/b4d9bd4a-e2d8-4904-923d-ee063ba5c10d.webp',
                  'https://image.hsv-tech.io/1920x0/bbx/common/b93d83bd-f71b-4a4a-b397-c3834c0d9ce0.webp',
                  'https://image.hsv-tech.io/1920x0/bbx/common/d3de56c8-37df-4d50-87a7-9d787f348190.webp',
                  'https://hsv-ecomm-production-bucket.s3.amazonaws.com/bbx/common/17937e94-03f2-4d42-8eea-cbaf99b98b29.webp',
                  'https://image.hsv-tech.io/1920x0/bbx/common/0f860ab6-eb8a-4df0-a8fb-6ffa0fee4e7e.webp'
                ]}
              />
              <img
                src={
