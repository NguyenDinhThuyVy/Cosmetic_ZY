...
export default function Accounts() {
  ...
  return (
    <div className='border border-gray-200 rounded-lg w-full px-4 pt-4 flex flex-col gap-8 items-center'>
      <h1 className='font items-center text-[24px] font-bold'>Quản lý thông tin người dùng</h1>
