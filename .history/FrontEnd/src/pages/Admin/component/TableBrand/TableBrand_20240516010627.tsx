...
function TableBrand() {
  ...
  function calculateProductCount(products: any) {
    return products
      .filter((product: any) => product.category === '6643a9985eafed2d94a7ee33')
      .map((product: any) => product.sphamr)
      .reduce((accumulator: any, currentValue) => accumulator + currentValue, 0)
  }
