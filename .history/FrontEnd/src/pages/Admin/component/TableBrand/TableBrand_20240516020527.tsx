...
function TableBrand() {
  ...
  const [viewBrandId, setViewBrandId] = useState<string | null>(null) // State to store the ID of the user being edited
  ...
  const handleView = (brandId: string) => {
    setViewBrandId(brandId) // Set the ID of the user being edited
  }
