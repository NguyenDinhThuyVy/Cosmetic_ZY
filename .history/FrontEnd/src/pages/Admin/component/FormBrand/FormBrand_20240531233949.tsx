...
const FormBrand: React.FC<CollectionCreateFormProps> = ({ brandId, onClose, onUpdateSuccess }) => {
    ...
    >
      <Form {...formItemLayout} form={form}>
        <div className='flex flex-col  gap-4 border border-gray-200 rounded-lg w-full px-4 pt-2  font  '>
          <h1 className='font items-center text-[14px] font-bold text-center'>Form thêm thương hiệu</h1>
          <div className=' '>
