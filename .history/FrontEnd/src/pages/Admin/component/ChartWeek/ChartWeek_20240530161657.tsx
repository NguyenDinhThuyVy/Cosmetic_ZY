...
function ChartWeek() {
  ...
  useEffect(() => {
    const handleGetAllAccount = async () => {
      const result = await admin.getAllAccount()
  ...
  console.log(paymentData?.data.data.length)
  console.log(usersData?.data.data.length)
  console.log(productsData?.data.data.length)
  return (
  ...
  useEffect(() => {
    if (paymentData?.data.data) {
      ...
      const revenueByDay = days.map((day) => {
        const filteredPayments = payments.filter((payment) => payment.createdAt.startsWith(day))
  ...
  useEffect(() => {
    if (paymentData?.data.data) {
      ...
      const revenueByMonth = months.map((month) => {
        const filteredPayments = payments.filter((payment) => payment.createdAt.startsWith(month))
