      ...
      render: (status: number, record: any) => {
        ...
        return (
          <Select
            ...
            style={{ color: status === 3 ? 'green' : status === 5 ? 'red' : '#e1b86b', width: 160 }}
          >
            <option value={1} className='text-red-400flex gap-8'>
              <ClockCircleOutlined className='mr-2'></ClockCircleOutlined> Đang chuẩn bị
            </option>
