                ...
                <Upload
                  ...
                  onChange={(info: any) => {
                    if (info.file.status === 'done') {
                      const uploadedImage = info.file.response.data // Lấy đường dẫn ảnh từ phản hồi của server
                      setimage(uploadedImage) // Cập nhật state image

                      form.setFieldsValue({ image: uploadedImage }) // Cập nhật form field
                    }
                  }}
                >
