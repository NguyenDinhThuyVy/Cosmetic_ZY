...
const FormBrandEdit: React.FC<CollectionCreateFormProps> = ({ brandId, onClose, onUpdateSuccess }) => {
  ...
  const updateBrandMutation = useMutation<AxiosResponse<SuccessResponse<User[]>, any>, unknown, [string, BrandData]>(
    (params: [string, BrandData]) => adminApi.updateBrand(...params),
    {
      onSuccess: () => {
        onUpdateSuccess()
        onClose()
