...
const FlashSale: FC<AppProps> = () => {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <ItemBrand id={} img={brand1} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand11} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand3} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand4} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand5} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand12} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand7} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand13} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand14} />
        </SwiperSlide>
        <SwiperSlide>
          <ItemBrand id={} img={brand10} />
        </SwiperSlide>
      </Swiper>
    </>
  )
