      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='border-gradient w-[92%] rounded-lg p-2 mt-4 flex flex-col gap-1 '>
          ...
          <p className='line-clamp-6'>
           Dưới đây là công dụng của sản phẩm. Bạn nên xem xét kỹ công dụng của từng sản phẩm để biết bản thân mình phù hơp với loại sản phẩm nào, và hiệu quả của sản phẩm đó trên da của chúng ta. 
          </p>
        </div>
        <AddPurchase
          product={product}
