      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='border-gradient w-[92%] rounded-lg p-2 mt-4 flex flex-col gap-1 '>
          ...
          <p className='line-clamp-6'>
            ...
            hơp với loại sản phẩm nào, và hiệu quả của sản phẩm đó trên da của chúng ta. `${product.uses}` . Chúc các
            bạn mãi xinh đẹp . Hãy luôn yêu thương bản thân mình nhé !
          </p>
        </div>
        <AddPurchase
          product={product}
