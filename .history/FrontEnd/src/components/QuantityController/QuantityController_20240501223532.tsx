  ...
  return (
    <div className={'flex  items-center justify-center border-2 border-gray-200 rounded-full'}>
      ...
      <InputNumber
        ...
        classNameInput='flex items-center px-3 w-[46px] h-[45px] text-base font-bold justify-center ml-3'
        onChange={handleChange}
        onBlur={handleBlur}
        value={value || localValue}
        {...rest}
      />
      <button className='flex items-center px-3 w-[40px] h-[45px] rounded-r-full hover:bg-gray-200' onClick={increase}>
        <span role='img' className='anticon'>
