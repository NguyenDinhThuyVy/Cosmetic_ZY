          ...
          <div className='flex-1 h-1/2 '>
            <div className='flex flex-col gap-2 items-center justify-center px-6'>
              ...
              <div className='text-[13px] flex gap-3 px-3'>
                <div className='font-semibold text-black'>{formatCurrency(product.price_before_discount)}</div>
                <div className='font-medium text-gray-400 line-through'>{product?.price_before_discount}</div>
