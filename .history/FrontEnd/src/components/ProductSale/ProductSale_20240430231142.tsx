...
export default function ProductSale({ product }: Props) {
  ...
  console.log(Number(rateSale(product.price_before_discount, product.price)))
  return (
      ...
      >
        <div className=' bg-[#ffffff]  w-[262px] flex flex-col justify-between gap-5 items-center rounded-2xl group-hover:scale-105'>
          <div className='flex-1 h-1/2  relative '>
            ...
            {Number(rateSale(product.price_before_discount, product.price)) > 0 ? (
              <div className='absolute left-3 top-4 transform  w-[40px] h-[40px] bg-[#252322] text-white px-1 py-2 rounded-full'>
          ...
          <div className='flex-1 h-1/2 '>
            <div className='flex flex-col gap-2 items-center justify-center px-6'>
              ...
              <div className='text-[13px] flex gap-3 px-3'>
                <div className='font-semibold text-black'>{formatCurrency(product.price)}</div>
