...
import { formatcurrency, generateName } from 'src/utils/item'
...
export default function ItemTop({ products }: Props) {
  ...
  return (
    <div className='relative h-full group '>
      <Link
        to={`${path.home}${generateName({ name: products.name, id: products._id })}`}
          ...
          <div className='flex-1 h-1/2 '>
            <div className='flex flex-col gap-2 items-center justify-center px-6'>
              ...
              <div className='text-[13px] flex gap-3 px-3'>
                <div className='font-semibold text-black'>{formatCurrency(products.price)}</div>
