...
function Header() {
  ...
  const handleSearchItemClick = (keyword) => {
        ...
        <div className='search w-2/5 flex flex-col gap-2 '>
          ...
          <div className='flex flex-wrap gap-3 text-xs ml-2'>
            <button
              ...
              onClick={() => handleSearchItemClick('Kem chống nắng')}
            >
              <span>Kem chống nắng</span>
            </button>
            <button className='text-gray-400 hover:text-red-400' onClick={() => handleSearchItemClick('Tẩy trang')}>
              <span>Tẩy trang</span>
            </button>
            <button
              className='text-gray-400 hover:text-red-400'
              onClick={() => handleSearchItemClick('Bông tẩy trang')}
            >
              <span>Bông tẩy trang</span>
            </button>
            <button className='text-gray-400 hover:text-red-400' onClick={() => handleSearchItemClick('Serum')}>
              <span>Serum</span>
            </button>
            <button className='text-gray-400 hover:text-red-400' onClick={() => handleSearchItemClick('Sửa rửa mặt')}>
