...
function Header() {
  ...
  const handleResetNotifications = () => {
    setCheck((prevCheck) => !prevCheck) // Đảo ngược giá trị của check
    setTotalNotifications(0) // Đặt totalNotifications về 0
  }
    ...
    <header className='font'>
      <div className='flex py-5 px-8  items-center gap-12 justify-center'>
        ...
        <div className='flex gap-8 items-center w-3/5 '>
          ...
          >
            <button className='flex-grow-1 relative' onClick={handleResetNotifications}>
