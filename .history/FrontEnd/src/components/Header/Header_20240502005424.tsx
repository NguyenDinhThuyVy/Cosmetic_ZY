        ...
        <div className='flex gap-8 items-center w-3/5 '>
          ...
          >
            <Link to={path.cart} className='relative'>
              ...
              {purchasesInCart && purchasesInCart.length > 0 && (
                <span className='absolute top-[-5px] left-[17px] rounded-full bg-white px-[9px] py-[1px] text-xs text-rose-500bg-clip-text text-transparent bg-gradient-to-r from-[#f0a80e] via-[#c43131] to-[#671f57] font-semibold '>
