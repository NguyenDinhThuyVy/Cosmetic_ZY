...
function Header() {
  ...
  return (
    <header className='font'>
      <div
        className={`fixed top-10 right-10 bg-white border border-gray-300 shadow-md rounded-md p-4 transition-transform transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}
      >
        <div className='flex items-center'>
          <div className='w-6 h-6 bg-blue-500 rounded-full mr-2'></div>
          <div className='text-gray-800'>hihi</div>
        </div>
      </div>
