    ...
    <nav className='border border-gray-200 rounded-lg w-full px-2 pb-8 bg-gray-100 font text-[15px]'>
      <div className='flex flex-col gap-8 items-center  py-4 '>
        <div className='flex flex-col gap-2 items-center'>
          <div className='h-15 w-15 flex overflow-hidden rounded-full border border-black/10'>
            <img src={getAvatarUrl(profile?.avatar)} alt='' className='h-15 w-15 object-cover rounded-full' />
          </div>
